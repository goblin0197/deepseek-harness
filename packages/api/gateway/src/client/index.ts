...
export interface RemoteHostFacts {
  ...
  /** Whether this page may read and write Host settings. */
...
class ClientRemoteService extends Service implements ClientRemote {
  ...
  get $host(): RemoteHostFacts {
    ...
    // itself changed. isLoopback and configurationProbe are fixed for the
    // page lifetime.
    ...
    if (this.hostFacts === undefined || this.hostFacts.home !== home) {
      this.hostFacts = {
        ...
        configurationProbe: this.connection.configurationProbe,
      }
    }
